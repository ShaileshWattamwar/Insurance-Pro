...
import com.microservices.Sellermodule.Config.HomeInsuranceFeign;
...
public class SellerServices {
    ...
    private HomeInsuranceFeign homeInsuranceFeign;
    ...
    public List<HomePolicyResponseDTO> getallhomecustomers(){
        return homeInsuranceFeign.getall();
    }

    public String deletehomecustomerbyid(long id){
        return homeInsuranceFeign.deletePolicy(id);
    }
}
